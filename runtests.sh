...
curl -X DELETE http://localhost:3000/businesses/3
curl -X DELETE http://localhost:3000/reviews/0
curl -X DELETE http://localhost:3000/reviews/1
curl -X DELETE http://localhost:3000/reviews/2
curl -X DELETE http://localhost:3000/reviews/3
curl -X DELETE http://localhost:3000/photos/0
curl -X DELETE http://localhost:3000/photos/1
curl -X DELETE http://localhost:3000/photos/2
curl -X DELETE http://localhost:3000/photos/3
...
curl http://localhost:3000/businesses/1/photos
printf "\n"